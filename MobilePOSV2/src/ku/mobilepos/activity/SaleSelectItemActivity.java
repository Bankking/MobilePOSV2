...
public class SaleSelectItemActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.sale_add_page);
		cart = Cart.getCartInstance();
		itemInCart = cart.getItemListInCart();
		
		// Button
		cancelButton = (Button)findViewById(R.id.sale_add_cancel);	
		searchButton = (ImageButton) findViewById(R.id.sale_add_search);
		...
		cancelButton.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				Intent goSaleMain = new Intent(getApplicationContext(),MainActivity.class);
	...
	public void createItemString(String[] item){
    	...
    	itemInventory = (ListView)findViewById(R.id.sale_add_itemlist);
